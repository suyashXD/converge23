        ...
        <div className="bee-col bee-col-2 bee-col-w5">
          ...
          <div className="bee-block bee-block-3 bee-image">
            <img
              ...
              src="https://www.linkpicture.com/q/Mudit.jpg"
          ...
          >
            ...
            >
              ...
              >
                <strong>REGISTRATION HEAD</strong>
              </span>
              <br />
            </p>
          </div>
          ...
          <div className="bee-block bee-block-5 bee-button">
            <a
              ...
              href="https://www.linkedin.com/in/mudit-sinha-7a990a211"
              target="_blank"
              rel="noreferrer"
              style={{
                fontSize: "16px",
        ...
        <div class="bee-col bee-col-3 bee-col-w5">
          ...
          <div class="bee-block bee-block-3 bee-image">
            <img
              ...
              src="https://www.linkpicture.com/q/Vanshita.png"
              style={{ maxWidth: "220px" }}
            />
          </div>
          ...
          <div className="bee-block bee-block-3 bee-text">
            ...
            >
              ...
              >
                ...
                >
                  <strong>HOSPITALITY HEAD</strong>
                </span>
              </p>
            </div>
          </div>
          ...
          <div class="bee-block bee-block-5 bee-button">
            <a
              ...
              href="https://www.linkedin.com/in/vanshita-varshney"
              target="_blank"
              rel="noreferrer"
              style={{
                fontSize: "16px",
