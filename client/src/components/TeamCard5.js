        ...
        <div className="bee-col bee-col-2 bee-col-w5">
          ...
          <div className="bee-block bee-block-3 bee-image">
            <img
              ...
              src="https://www.linkpicture.com/q/Satyansh.jpg"
          ...
          <div className="bee-block bee-block-5 bee-button">
            <a
              ...
              href="https://www.linkedin.com/in/satyansh-gupta-a12a16239"
              target="_blank"
              rel="noreferrer"
              style={{
                fontSize: "16px",
        ...
        <div class="bee-col bee-col-3 bee-col-w5">
          ...
          <div class="bee-block bee-block-3 bee-image">
            <img
              ...
              src="https://www.linkpicture.com/q/Ayush.jpg"
              style={{ maxWidth: "220px" }}
            />
          </div>
          ...
          <div class="bee-block bee-block-5 bee-button">
            <a
              ...
              href="https://www.linkedin.com/in/ayush-singh-4391b6105"
              target="_blank"
              rel="noreferrer"
              style={{
                fontSize: "16px",
