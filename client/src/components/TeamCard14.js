        ...
        <div className="bee-col bee-col-2 bee-col-w5">
          ...
          <div className="bee-block bee-block-3 bee-image">
            <img
              ...
              src="https://www.linkpicture.com/q/Vivan.jpg"
          ...
          <div className="bee-block bee-block-5 bee-button">
            <a
              ...
              href="https://www.linkedin.com/in/vivaan-jain-806677232"
              target="_blank"
              rel="noreferrer"
              style={{
                fontSize: "16px",
        ...
        <div class="bee-col bee-col-3 bee-col-w5">
          ...
          <div class="bee-block bee-block-3 bee-image">
            <img
              ...
              src="https://www.linkpicture.com/q/Shivam.jpg"
              style={{ maxWidth: "220px" }}
            />
          </div>
          ...
          <div class="bee-block bee-block-5 bee-button">
            <a
              ...
              href="https://www.linkedin.com/in/shivam-rajput-24a0521b8"
              target="_blank"
              rel="noreferrer"
              style={{
                fontSize: "16px",
